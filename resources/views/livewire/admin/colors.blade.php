    ...
    <table class="table table-striped table-hover">
        ...
        @foreach($colors as $index => $color)
            <tr>
                ...
                <td class="text-center align-middle" style="background-color: {{$color->code}}"></td>
                ...
                <td class="text-center align-middle">
                    <form action="{{ route('colors.destroy', $color->id) }}" method="POST" onsubmit="return confirm('آیا مطمئن هستید؟');">
                        @csrf
                        @method('DELETE')
                ...
                <td class="text-center align-middle">
                    {{Verta::instance($color->created_at)->format('%d, %B, %Y')}}
                </td>
            </tr>
        @endforeach
    </table>
